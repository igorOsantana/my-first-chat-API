...
import { DeclineFriendshipUseCase } from './decline.usecase';

describe('DeclineFriendshipUseCase', () => {
  let friendshipRepository: TFriendshipRepository;
  let sut: DeclineFriendshipUseCase;
  ...
  beforeEach(async () => {
    ...
    sut = moduleRef.get<DeclineFriendshipUseCase>(DeclineFriendshipUseCase);
  });
  ...
  test('it should call the update method of the FriendshipRepository filtering by the payload and with the "status" as "DECLINED"', async () => {
